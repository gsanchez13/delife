            ...
            <main role="main">
                <div className="jumbotron bg-warning">
                    <div className="container">
                        <h1 className="display-3">Welcome to VeloxVida. </h1>
                ...
                <div className="container mb-5">
                    <div className="row">
                        ...
                        <div className="col-lg-4 mt-3">
                            <h3>Store Signup</h3>
                            <p className="font-weight-light">
                                The store platform will consist of an online marketplace for small businesses to connect to. You will recieve notifications of orders placed, as well as time estimated for courier pickup and successful delivery notification. into addition, the live inventory will help you keep track of what needs to be replenished and an steady overview of your business's sales. Sign up now to become a partner once VeloxVida 1.0 launches.
                            </p>
