            ...
            <main role="main">
                ...
                <div className="row mx-auto my-auto">
                    <div className="col-lg-3 my-5 mx-auto text-center py-2">
                        <img src="/bags.svg" style={{ "height": "150px" }}></img>
                    </div>
                    <div className="col-lg-3 my-auto mx-auto text-center">
                        <img src="/bike.svg" style={{ "height": "150px" }}></img>
                    </div>
                    <div className="col-lg-3 my-auto mx-auto text-center">
                        <img src="/store.svg" style={{ "height": "150px" }}></img>
                    </div>
                    ...
                    <div className="col-lg-6 py-3 px-5 pl-3" style={{ "backgroundColor": "#EFDDD0" }}>
